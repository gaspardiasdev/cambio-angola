// src/services/api.js
const API_BASE_URL = import.meta.env.production.VITE_API_URL || "http://localhost:5000";
const REQUEST_TIMEOUT = Number(import.meta.env.production.VITE_API_TIMEOUT) || 30000;
